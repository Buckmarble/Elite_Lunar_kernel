...
# Setup the build
 cd $k/arch/arm/configs/BBKconfigs/GPE
    for c in *
      do
        cd $k
...
TOOLCHAIN=/home/brymaster5000/kernel/arm-eabi-4.7/bin/arm-eabi-
export ARCH=arm
export SUBARCH=arm
...
# Build Zip
 clear
   echo "Creating $z.zip"
     cd $k/out/$c/
       7z a "$z.zip"
         mv $z.zip $k/out/$z-stock_clk.zip
